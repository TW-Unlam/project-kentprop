...
<div class="bg-container">
    <div class="search-container">
        <h4 class="form-signin-heading">Deje Su Consulta Al Propietario de la Publicacion</h4>
        <div class="search-container_img">
            <img src="images/kentprop-logo.png" alt="KentProp logo">
        </div>

        <div id="FormConsultabox" style="margin-top:30px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
